    ...
    >
      ...
      <section className="w-full h-screen flex flex-col justify-center items-center text-center p-6">
        ...
        <motion.img
          src="/eye.jpg"
          alt="Future Vision"
          className="w-40 h-40 mt-6 mb-6 rounded-full object-cover shadow-[0_0_40px_#00ffff] mx-auto"
        ...
        <div className="text-cyan-300 drop-shadow-[0_0_15px_#00ffff] text-center w-full flex justify-center">
          <Animation text={rotatingTexts[index]} />
        </div>

        <motion.p
          className="p text-white max-w-xl mt-6 leading-relaxed text-lg opacity-90 mx-auto text-center"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
      ...
      {/* PROJECTS */}
      <section className="w-full flex flex-col items-center gap-20 py-20 px-4">
        ...
        >
          <div className="project-inner justify-center items-center text-center">
            <img src="/afrater.jpg" className="project-img" alt="AFRATER" />
            <div className="text-center">
              <h3 className="project-title">AFRATER</h3>
              <p className="project-text mx-auto">
      ...
      {/* SKILLS */}
      <section className="p-10 bg-black/40 backdrop-blur-md border-t border-cyan-700/40 text-center">
        <h2 className="skill text-4xl font-bold text-center mb-10 text-cyan-300 drop-shadow-[0_0_15px_#00ffff]">Skills</h2>

        <div className="grid md:grid-cols-3 text-center gap-10 justify-items-center">
      ...
      <section className="contact p-12 text-center flex flex-col items-center">
      ...
      <section className="py-8 text-center flex justify-center">
        <a
